...
const SearchBar = () => {
  ...
  const handleSearch = (e) => {
    ...
    searchQuery.includes("health packages") || searchQuery.includes("health") || searchQuery.includes("health package")
                ...
                {filteredServices.map((doctor) => (
                  ...
                  >
                    <li className="hover:bg-blue-100 col-span-5 p-2 text-gray-800 rounded-md transition-colors duration-300">
                      <div className="flex">
                        <div className="bg-blue-800 text-white px-2 py-1 rounded-md text-xs">Service</div>
                      </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                >
                  <li className="hover:bg-blue-100 col-span-5 p-2 text-gray-800 rounded-md transition-colors duration-300">
                    <div className="flex">
                      <div className="bg-blue-800 text-white px-2 py-1 rounded-md text-xs">Package</div>
                    </div>
                    <div className="grid grid-cols-6">
