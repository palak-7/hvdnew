            ...
            <div className="lg:grid grid-cols-12 items-center">
              ...
              <div className="col-span-4 p-5 lg:p-14">
                ...
                <p className="text-lg mt-2 flex">
                  ...
                  <div>
                    <span className="font-semibold">2. Stay Hydrated: </span>
                ...
                <p className="text-lg flex">
                  ...
                  <div>
                    <span className="font-semibold">
                      4. Fasting Guidelines (if required): </span>
            ...
            <div className="lg:grid grid-cols-12">
              <div className="col-start-4 col-span-6">
                <p className="text-lg flex px-5">
                  ...
                  <div>
                    <span className="font-semibold">
                      5. Inform Your Doctor About Health Conditions:{" "}
                    </span>
                ...
                <p className="text-lg mt-2 flex px-5">
                  ...
                  <div>
                    <span className="font-semibold">
                      8. Arrange for Transportation (if necessary):{" "}
                    </span>
